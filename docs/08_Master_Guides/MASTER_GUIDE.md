...
│   ├── specs/                   # Phase별 명세
│   │   ├── 001-feature-store/
│   │   ├── 002-data-integration/
│   │   └── ...
│   └── templates/               # 템플릿
│
├── backend/                     # FastAPI 백엔드
│   ├── main.py                  # API 서버 엔트리
│   ├── config.py                # Constitution 규칙
│   │
│   ├── data/                    # 데이터 레이어
│   │   ├── feature_store/       # Phase 1: 2-Layer Cache
│   │   ├── collectors/          # Phase 2: Yahoo Finance
│   │   └── news_models.py       # Phase 8: 뉴스 DB
│   │
│   ├── ai/                      # AI 레이어
│   │   ├── agent.py             # Phase 3: Trading Agent
│   │   ├── ensemble.py          # Phase 5: Multi-AI
│   │   └── rag/                 # Phase 13: RAG
│   │
│   ├── strategies/              # Phase 4: 전략
│   │   ├── ai_factors.py
│   │   ├── risk.py
│   │   └── management.py
│   │
│   ├── execution/               # Phase 6: 실행
│   │   ├── smart_execution.py
│   │   └── broker.py
│   │
│   ├── backtesting/             # Phase 10: 백테스트
│   │   └── event_driven.py
│   │
│   └── apis/                    # REST APIs
│       ├── signals.py           # Phase 9
│       ├── backtest.py          # Phase 10
│       └── trading.py           # Phase 11
│
...
**상세 문서**: `docs/Phase6_Integration.md`
...
**상세 문서**: `docs/Production_Deployment_Guide.md`
...
**상세 문서**: `docs/Telegram_Notifications.md`
...
**상세 문서**: `docs/PaperTrading_Guide.md`
