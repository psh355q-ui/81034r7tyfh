...
1. **[251210_ARCHITECTURE_INTEGRATION_PLAN.md](251210_ARCHITECTURE_INTEGRATION_PLAN.md)** (1,200+ lines)
   - 7가지 아키텍처 개선 전체 계획
   - Skill Layer, Semantic Router, Docker Sandbox, Tool Caching
   - Code Model Pattern, MCP Gateway, Local LLM
   - 구현 우선순위 및 체크리스트

2. **[251210_SEMANTIC_ROUTER_GUIDE.md](251210_SEMANTIC_ROUTER_GUIDE.md)** (500+ lines)
   - Semantic Router 사용 가이드
   - Intent 분류, Tool 선택, Model 라우팅
   - 성능 벤치마크
   - 통합 예시 (FastAPI, Signal Pipeline)

3. **[251210_TOKEN_OPTIMIZATION_SUMMARY.md](251210_TOKEN_OPTIMIZATION_SUMMARY.md)** (400+ lines)
   - 구현 완료 보고서
   - 성능 개선 결과
   - 비용 절감 효과
   - 사용 방법 및 예시

4. **[251210_SIGNAL_PIPELINE_GUIDE.md](251210_SIGNAL_PIPELINE_GUIDE.md)** (기존)
   - Signal Pipeline 전체 가이드
   - 뉴스 → AI 분석 → 신호 생성
   - WebSocket 브로드캐스트

5. **[251210_KIS_TRADING_INTEGRATION.md](251210_KIS_TRADING_INTEGRATION.md)** (기존)
   - KIS API 통합 가이드
   - 주문 실행, 계좌 조회
   - 모의투자 설정
...
### 구현 관련
1. [251210_ARCHITECTURE_INTEGRATION_PLAN.md](251210_ARCHITECTURE_INTEGRATION_PLAN.md) - 전체 아키텍처 계획
2. [251210_SEMANTIC_ROUTER_GUIDE.md](251210_SEMANTIC_ROUTER_GUIDE.md) - Semantic Router 가이드
3. [251210_TOKEN_OPTIMIZATION_SUMMARY.md](251210_TOKEN_OPTIMIZATION_SUMMARY.md) - 구현 완료 보고서

### 기존 시스템
4. [251210_SIGNAL_PIPELINE_GUIDE.md](251210_SIGNAL_PIPELINE_GUIDE.md) - Signal Pipeline 가이드
5. [251210_KIS_TRADING_INTEGRATION.md](251210_KIS_TRADING_INTEGRATION.md) - KIS API 통합

### 프로젝트 전체
6. [251210_MASTER_GUIDE.md](251210_MASTER_GUIDE.md) - 전체 가이드
